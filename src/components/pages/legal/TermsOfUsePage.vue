<template>
  <div id="content-holder">
    ...
    <p>
      The work.download website located at work.download is a copyrighted work
      belonging to work.download. Certain features of the Site may be subject to
    ...
    <p>
      ...
      work.download uses ‘cookies’. These cookies are used to store information
    ...
    <p>
      ...
      should be sent to: contact@work.download. After the Notice is received,
    ...
    <p>Email: contact@work.download</p>
  </div>
</template>
